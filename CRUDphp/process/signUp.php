<?php
    ...
    $queryInsert="insert into users_data(uid,firstName,lastName,addr1,addr2,city,state,zip,checkbox1,fileName) values($uid,'$firstName','$lastName','$addr1','$addr2','$city','$state','$zip','$checkbox','$pic');";
